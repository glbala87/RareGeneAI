"""Alembic migration environment for RareGeneAI.

Reads database URL from RAREGENEAI_DATABASE_URL environment variable.
...
db_url = os.environ.get("RAREGENEAI_DATABASE_URL", "sqlite:///raregeneai.db")
